...
class NONLocalDotProductBlock2D(_NonLocalBlockND):
    def __init__(self, in_channels, inter_channels=None, sub_sample=True, bn_layer=True):
        super(NONLocalDotProductBlock2D, self).__init__(in_channels,
                                              inter_channels=inter_channels,
...
if __name__ == '__main__':
    ...
    for (sub_sample_, bn_layer_) in [(True, True), (False, False), (True, False), (False, True)]:
        ...
        net = NONLocalDotProductBlock2D(3, sub_sample=sub_sample_, bn_layer=bn_layer_)
        out = net(img)
        print(out.size())
